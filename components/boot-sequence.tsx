...
export default function BootSequence() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <div className="w-full max-w-2xl bg-black/70 backdrop-blur-md p-8 rounded-md border border-primary/30 font-mono text-primary">
          ...
          {currentMessageIndex === bootMessages.length && (
            <div className="flex mt-4">
              ...
              <span className="typing-animation text-foreground/90">
                Boot sequence complete. Welcome to Rithani's secure terminal.
              </span>
